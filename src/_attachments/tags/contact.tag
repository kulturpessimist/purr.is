<contact>
	...
	<section id="contact">
		...
		<div class="card narrow chat active">
			<p class="other">
				Good evening!
			</p>
			<p class="other">
				Do you have some interesting projects where we can help you? Or do you just want to say hello or come over for a beer? Just use our lovely contact form below...
			</p>
		...
		<!--
		<div class="card narrow chat ">
			ok
		</div>

		<a href="#next" class="next">
			<img src="img/arrow.png" alt="scroll right" />
		</a>
		-->
